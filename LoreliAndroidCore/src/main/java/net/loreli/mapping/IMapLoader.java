...
public interface IMapLoader {
	...
	/**
	 * This method loads a map-tile of the specified location. When the tile is loaded {@link IMapLoader.IListener.onMapLoaded(TileLocation)} of the listener is called.
	 * When the tile couldn't be loaded {@link IMapLoader.IListener.onMapLoadedFailed(TileLocation)} of the listener is called instead.
	 ...
	 * @return The tile-image of the specified location if possible, <b>null</b> otherwise. See {@link Bitmap}.
	 */
