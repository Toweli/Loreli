...
import net.loreli.factory.Creater;
...
public class ObjectSerializer
{
	...
	private ObjectSerializer()
	{
		...
		m_oFactory = (Factory<IObjectReaderWriter>)(FactoryRegister.getInstance().getFactory("ObjectReaderWriterFactory"));
	}
	...
	public void serialize(Object oObject, ISerializer oSerializer)
	{
		IObjectReaderWriter oReaderWriter = m_oFactory.createObject(oObject.getClass().getName());
